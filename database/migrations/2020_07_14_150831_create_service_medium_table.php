...
class CreateServiceMediumTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('service_medium', function (Blueprint $table) {
            $table->bigIncrements('id')->index();
            $table->bigInteger('service_id')->default(0)->index();
    ...
    {
        Schema::dropIfExists('service_medium');
    }
}
